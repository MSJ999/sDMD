...
char path[1024];
char names[NumofFileType][256] = {"SysInfo.dat", "WallInfo.dat", "ObstInfo.dat", "CGInfo.dat", "", "", "out_log.txt", "out_REMD.txt", "rPBCGRO.gro", "Energy.txt", "HBInfo.txt", "AAMark.txt", "AggNum.txt", "RG.txt", "RMSD.txt", "PotMap.txt", "PotMap_T.txt", "PMFMap_T.txt"};
